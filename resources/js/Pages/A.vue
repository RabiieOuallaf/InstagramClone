    ...
    <MainLayout>
            ...
            <div class="flex items-center md:justify-between">
                <label for="fileUser">
                    <img class="rounded-full object-fit md:w-[200px] w-[100px] cursor-pointer"
                        src="https://picsum.photos/id/50/500/320">
                </label>
                <input id="fileUser" class="hidden" type="file"
        ...
        <div class="md:hidden">
            <div class="w-full flex items-center justify-around border-t border-t-gray-300 mt-8">
                ...
                <div class="text-center p-3">
                    <div class="font-extrabold">454</div>
                    <div class="text-gray-400 font-semibold -mt-1.5">followers</div>
                </div>

                <div class="text-center p-3">
                    <div class="font-extrabold">98</div>
                    <div class="text-gray-400 font-semibold -mt-1.5">following</div>
                </div>
            </div>
        </div>

        <div class="w-full flex items-center justify-around border-t border-t-gray-300">

            <div class="p-3 w-1/4 flex justify-center border-t border-t-gray-900">
                <Grid :size="28" fillColor="#E8E8E8" class="cursor-pointer" />
            </div>

            <div class="p-3 w-1/4 flex justify-center border-t border-t-gray-900">
                <PlayBoxOutline size="28" fillColor="#E8E8E8" class="cursor-pointer" />
            </div>

            <div class="p-3 w-1/4 flex justify-center border-t border-t-gray-900">
                <AccountBoxOutline size="28" fillColor="#E8E8E8" class="cursor-pointer" />
            </div>
        </div>
            ...
            <div class="md:block mt-10 hidden border-t border-t-gray-300">
                <div
                    ...
                    <div class="p-[17px] w-1/4 flex justify-center items-center border-t border-t-gray-900">
                        ...
                        <div class="ml-2 -mb-[1px] text-gray-900">POSTS
